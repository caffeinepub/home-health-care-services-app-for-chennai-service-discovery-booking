...
export class Backend implements backendInterface {
    ...
    async getUserBookings(arg0: Principal): Promise<Array<BookingRequest>> {
        if (this.processError) {
            try {
    ...
    async requestBooking(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.requestBooking(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
